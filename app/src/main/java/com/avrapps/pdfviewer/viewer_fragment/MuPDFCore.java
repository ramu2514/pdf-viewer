...
public class MuPDFCore {
    ...
    public void addBookmark() {
        PdfBookmarks pdfBookmarks = new PdfBookmarks(filePath, currentPage);
        pdfBookmarks.save();
    }
    ...
    public boolean isBookmarkedAlready() {
        return PdfBookmarks.isBookmarkedAlready(filePath, currentPage);
    }
    ...
    public void removeBookmark() {
        PdfBookmarks.removeBookmark(filePath, currentPage);
    }
