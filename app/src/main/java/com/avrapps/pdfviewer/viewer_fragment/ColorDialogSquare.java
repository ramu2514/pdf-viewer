...
public class ColorDialogSquare extends View {
    final float[] color = {1.f, 1.f, 1.f};
    Paint paint;
    Shader luar;

    public ColorDialogSquare(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ColorDialogSquare(Context context, AttributeSet attrs, int defStyle) {
