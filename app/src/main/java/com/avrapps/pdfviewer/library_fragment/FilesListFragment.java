    ...
    public class FilesListRecycler extends RecyclerView.Adapter<FilesListRecycler.ViewHolder> {
        ...
        public void openSelected() {
            if (selectedFiles.size() > 0) {
                ...
                FirebaseUtils.analyticsFileOpen(activity,"FILE_OPEN_MANY_LIBRARY",uri);
            }
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View itemView) {
                ...
                View.OnClickListener listener = v -> {
                    ...
                    int position = getAdapterPosition();
                    if (!checkboxVisible) {
                        Uri uri = Uri.fromFile(data.get(position));
                        MiscUtils.openDoc(uri, activity, selectedFiles);
                        FirebaseUtils.analyticsFileOpen(activity,"FILE_OPEN_OPEN_MANY_LIBRARY",uri);
                    }
                };
